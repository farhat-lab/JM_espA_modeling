...
plt = genes %>%
  ...
  labs(title = "Variants & Binding Sites", x = "Position", y = "") +
  scale_fill_brewer(palette = "Dark2")+
  scale_color_manual(values=c("black", "#e41a1c"))
ggsave(sprintf("%s/mutation_bindingsites.png", figsavepath), plt)
plt
```
...
wilcox.test(NormalGroup, DeletionGroup, alternative="less")
```